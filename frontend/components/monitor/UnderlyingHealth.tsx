      ...
      {rows.length === 0 ? (
        ...
        <>
          ...
          <div className="hidden min-h-0 flex-1 overflow-auto md:block">
            <table className="data-table font-mono tabular-nums">
              <thead className="sticky top-0 z-10">
                <tr>
                  <th className="sticky left-0 z-20 text-left">Stream</th>
                  <th className="text-right">Connection</th>
                  <th className="text-right">Frames</th>
                  <th className="text-right">
                    <span className="inline-flex items-center gap-1">
                      Elapsed loss
                      <Explanation label="Explain elapsed loss">
                        Missing frames compared with grid seconds that have elapsed. This is the live health signal.
                      </Explanation>
                    </span>
                  </th>
                  <th className="text-right">Day progress</th>
                  <th className="text-right">Bytes / frame</th>
                  <th className="text-right">Projected EOD</th>
                  <th className="text-right">File</th>
                  <th className="text-right">Last tick</th>
              ...
              <tbody>
                {rows.map((row) => (
                  <tr key={row.underlying}>
                    ...
                    <td className={row.connected ? "text-success" : "text-danger"}>
